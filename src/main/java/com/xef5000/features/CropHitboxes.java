...
import com.xef5000.mixin.BlockAccessor;
...
public class CropHitboxes {
    ...
    public static final AxisAlignedBB[] CARROT_POTATO_BOX_one = {
            new AxisAlignedBB(0.0D, 0.0D, 0.0D, 1.0D, 0.125D, 1.0D),
            new AxisAlignedBB(0.0D, 0.0D, 0.0D, 1.0D, 0.1875D, 1.0D),
            new AxisAlignedBB(0.0D, 0.0D, 0.0D, 1.0D, 0.25D, 1.0D),
            new AxisAlignedBB(0.0D, 0.0D, 0.0D, 1.0D, 0.3125D, 1.0D),
    ...
    public static final AxisAlignedBB[] NETHER_WART_BOX_one = {
            new AxisAlignedBB(0.0D, 0.0D, 0.0D, 1.0D, 0.3125D, 1.0D),
            new AxisAlignedBB(0.0D, 0.0D, 0.0D, 1.0D, 0.5D, 1.0D),
            new AxisAlignedBB(0.0D, 0.0D, 0.0D, 1.0D, 0.6875D, 1.0D),
            new AxisAlignedBB(0.0D, 0.0D, 0.0D, 1.0D, 1.0D, 1.0D)
    ...
    public static void updateCropsMaxY(World world, BlockPos pos, Block block) {
        ...
        if (FrogMod.INSTANCE.getFrogModConfig().oneByOneCrops) {
            accessor.setMaxY(
                    blockState.getBlock() instanceof BlockPotato || blockState.getBlock() instanceof BlockCarrot
                            ? CARROT_POTATO_BOX_one[ageValue].maxY
        ...
        accessor.setMaxY(blockState.getBlock() instanceof BlockPotato || blockState.getBlock() instanceof BlockCarrot
